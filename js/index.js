function SlideShow(boxDom,imgs,timespace,btnColor,btnHighColor){
	//1）、属性
	this.boxDom = boxDom;
	...
	this.initUI = function(){
		...
		ulDom.style.cssText = "position:absolute;right:540px;bottom:20px;height:40px;";
		//3、创建li
		for(let i=0;i<this.imgs.length;i++){
			let liDom = document.createElement("li");
			liDom.style.cssText = "float:left;margin-left:2px;width: 40px;height: 2px;";
...
window.onload = function(){
	let s = new SlideShow($("indexbg"),["img/indexbg1.jpg","img/indexbg1.jpg","img/indexbg1.jpg","img/indexbg1.jpg"],3000,"#555555","#e95f46");
	s.initUI();
	s.initEvent();
	s.autoChange();
